...
[rewrite local]
^https:\/\/api\.yuncheapp\.cn\/pearl-incentive\/api\/v1\/task\/intervalAward\/receive url script-request-header https://raw.githubusercontent.com/mandxy/ziyong/main/kkd.js
#loon
http-request ^https:\/\/api\.yuncheapp\.cn\/pearl-incentive\/api\/v1\/task\/intervalAward\/receive script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/kkd.js, requires-body=true, timeout=10, tag=快看点cookie
#surge
kkdcookie = type=http-request,pattern=^https:\/\/api\.yuncheapp\.cn\/pearl-incentive\/api\/v1\/task\/intervalAward\/receive,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/kkd.js,script-update-interval=0
*/
const jsname='快看点'
const $ = Env(jsname)
