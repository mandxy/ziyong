/*
看一个视频弹出金币获取videoheader and videobody(存在一定几率获取不到videobody）
多试几次 and 金蛋获取 


gold body(第六个视频，最后一圈）
...
#圈x
[rewrite local]
https:\/\/veishop\.iboxpay\.com\/nf_gateway\/nf_customer_activity\/day_cash\/v1\/give_gold_coin_by_video\.json url script-request-body https://raw.githubusercontent.com/mandxy/ziyong/main/xp.js
#loon
http-request https:\/\/veishop\.iboxpay\.com\/nf_gateway\/nf_customer_activity\/day_cash\/v1\/give_gold_coin_by_video\.json script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/xp.js, requires-body=true, timeout=10, tag=笑谱
#surge
笑谱 = type=http-request,pattern=^https:\/\/veishop\.iboxpay\.com\/nf_gateway\/nf_customer_activity\/day_cash\/v1\/give_gold_coin_by_video\.json,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/xp.js,script-update-interval=0
*/
const jsname='笑谱'
const $ = Env(jsname)
