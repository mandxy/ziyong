...
async function sendNotify(
  ...
  desp = desp.replace("京豆车扫码/短信登陆: https://ark.leafxxx.win\n","")
  desp = desp.replace("TG自助京东CK登陆: https://t.me/leaf_jd_bot\n","")
  desp = desp.replace("TG自助朴朴/永辉CK登陆: https://t.me/leaf_dg_bot\n","")
  desp = desp.replace("京东车请优先使用短信登录, 登录不上的可以等晚上8点后再尝试短信登录\n","")
  desp = desp.replace("美团: https://raw.githubusercontent.com/leafTheFish/DeathNote/main/meituanV3.js\n","")
  desp = desp.replace("联通/传祺/滴滴/永辉/朴朴/顺丰 扫码/短信获取ck, 美团/饿了么领券地址: https://service.leafxxx.win\n","")
