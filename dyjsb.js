...
两个CK signheader 和 signcookie已签到获取不到
...
#loon
http-request ^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/sign_in/detail? script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版sign
http-request ^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/done/read? script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版read
http-request ^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/walk/step_submit? script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js, requires-body=true, timeout=10, tag=抖音极速版step
#surge


#圈x
[rewrite local]
https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/sign_in/detail? url script-request-header https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js
https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/done/read? url script-request-header https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js
https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/walk/step_submit? url script-request-header https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js

dyjsbsign = type=http-request,pattern=^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/sign_in/detail?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js,script-update-interval=0
dyjsbread = type=http-request,pattern=^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/done/read?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js,script-update-interval=0
dyjsbstep = type=http-request,pattern=^https://(aweme-\w+|aweme).snssdk.com/luckycat/aweme/v1/task/walk/step_submit?,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/mandxy/ziyong/main/dyjsb.js,script-update-interval=0
*/
const jsname='抖音极速版'
const $ = Env(jsname)
